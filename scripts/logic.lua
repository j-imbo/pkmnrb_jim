...
function guard()
    return has("tea") or (has("op_tea_off") and (flylavender() or flyceladon()
...
function lavender()
    return (
      ...
      or ((flypewter() or flycerulean() or flyvermillion() or oldman()) and ((cancut() and canflash()) or guard()))
      or (flyfuchsia() and ((pokeflute() and (boulders() or bike())) or cansurf()))
      or (canstrength() and cansurf())
      or (flysaffron() and guard())
    )
...
function fuchsia()
    return (
        ...
        or ((flypewter() or flycerulean() or flyvermillion() or oldman())
            and (((cancut() and canflash()) or guard()) and (((pokeflute() and (boulders() or bike())) or cansurf()))))
